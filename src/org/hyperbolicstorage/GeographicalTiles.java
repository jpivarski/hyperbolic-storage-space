...
public class GeographicalTiles {
    ...
    public static String dungeonPoint(int latitude, long longitude, double x, double y) {
        double size = Math.pow(2, latitude);
        Point2D xy = halfPlane_to_hyperShadow(new Point2D((x + longitude)*size, y*size));
    ...
    public static boolean writeDungeon(OutputStream stream, boolean comma, double offsetx, double offsety, double radius) throws IOException {
        ...
        for (int latitude = latitudes.min;  latitude <= latitudes.max;  latitude++) {
            ...
            for (long longitude = longitudes.min;  longitude <= longitudes.max;  longitude++) {
                ...
                stream.write(("{\"d\": [[" + dungeonPoint(latitude, longitude, 0.94, 1.7) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.06, 1.7) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.06, 1.88) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.2, 1.88) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.2, 2.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.076, 2.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.076, 2.02) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.924, 2.02) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.924, 2.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.8, 2.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.8, 1.88) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.94, 1.88) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#8a8a91\"}\n").getBytes());
                stream.write((",{\"strokeStyle\": \"none\", \"d\": [[" + dungeonPoint(latitude, longitude, 0.96, 1.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.96, 1.2) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.04, 1.2) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.04, 1.0) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#8a8a91\"}\n").getBytes());
                stream.write((",{\"d\": [[" + dungeonPoint(latitude, longitude, 0.96, 1.0) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.96, 1.2) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.04, 1.2) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.04, 1.0) + "]], \"lineWidth\": 2.0, \"type\": \"polygon\"}\n").getBytes());
                stream.write((",{\"d\": [[" + dungeonPoint(latitude, longitude, 0.20857304, 1.96806026) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.49841873, 1.9563980099999998) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.49685719, 1.91759007) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.20701150000000001, 1.92925251) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#803300\"}\n").getBytes());
                stream.write((",{\"d\": [[" + dungeonPoint(latitude, longitude, 0.7910365699999999, 1.96806026) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.50119088, 1.9563980099999998) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.5027523899999999, 1.91759007) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.79259808, 1.92925251) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#803300\"}\n").getBytes());
                stream.write((",{\"d\": [[" + dungeonPoint(latitude, longitude, 1.0209121, 1.69446172) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.0110929, 1.4504207599999999) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.97841788, 1.4517355299999999) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.98823729, 1.6957764899999999) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#803300\"}\n").getBytes());
                stream.write((",{\"d\": [[" + dungeonPoint(latitude, longitude, 1.0209121, 1.20404573) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 1.0110929, 1.4480867000000002) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.97841788, 1.44677195) + ", \"L\"], [" + dungeonPoint(latitude, longitude, 0.98823729, 1.20273099) + ", \"L\"]], \"lineWidth\": 2.0, \"type\": \"polygon\", \"fillStyle\": \"#803300\"}\n").getBytes());
